...
const BLOG = {
  ...
  NOTION_PAGE_ID:
        process.env.NOTION_PAGE_ID || '401dc673069643d1a4409f1bc5c87b09',
  ...
  SINCE: process.env.NEXT_SINCE || 2016, // e.g if leave this empty, current year will be used.
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Hang Ke', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'Learning is a lifelong task.', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://kehang.net', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'kehang.net,blog,KeHang,Ke Hang,hangke', // 网站关键词 英文逗号隔开
  ...
  DESCRIPTION:
        process.env.NEXT_PUBLIC_DESCRIPTION || "KeHang's Window", // 站点描述，被notion中的页面描述覆盖
